...
public class CampaignOpsReputation extends AbstractUnitRating {
    ...
    int calcTechSupportValue() {
        ...
        for (Person tech : getCampaign().getTechs()) {
            ...
            if ((tech.getPrimaryRoleInt() == Person.T_MECH_TECH || tech.getSecondaryRoleInt() == Person.T_MECH_TECH) && tech.getSkill(SkillType.S_TECH_MECH) != null) {
                setMechTechTeams(getMechTechTeams() + 1);
                astechTeams--;
            } else if ((tech.getPrimaryRoleInt() == Person.T_AERO_TECH || tech.getSecondaryRoleInt() == Person.T_AERO_TECH)  && tech.getSkill(SkillType.S_TECH_AERO) != null) {
                setAeroTechTeams(getAeroTechTeams() + 1);
                astechTeams--;
            } else if ((tech.getPrimaryRoleInt() == Person.T_MECHANIC || tech.getSecondaryRoleInt() == Person.T_MECHANIC)  && tech.getSkill(SkillType.S_TECH_MECHANIC) != null) {
                setMechanicTeams(getMechanicTeams() + 1);
                astechTeams--;
            } else if ((tech.getPrimaryRoleInt() == Person.T_BA_TECH || tech.getSecondaryRoleInt() == Person.T_BA_TECH)  && tech.getSkill(SkillType.S_TECH_BA) != null) {
