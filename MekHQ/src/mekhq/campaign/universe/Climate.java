...
public enum Climate {
    ...
    ARCTIC(150, 267, "Arctic"),
    BOREAL(268, 277, "Boreal"),
    TEMPERATE(278, 287, "Temperate"),
    WARM(288, 297, "Warm"),
    TROPICAL(298, 307, "Tropical"),
    SUPERTROPICAL(308, 317, "Supertropical"),
    ...
    Climate(int minTemp, int maxTemp, String climateName) {
