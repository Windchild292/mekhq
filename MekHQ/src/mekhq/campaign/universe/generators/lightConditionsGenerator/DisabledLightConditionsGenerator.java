 ...
 */
public class DisabledLightConditionsGenerator extends AbstractLightConditionsGenerator {
    //region Constructors
    public DisabledLightConditionsGenerator() {
        super(LightConditionsGenerationMethod.NONE);
    }
