...
public class MissingMekLocation extends MissingPart {
    ...
    public void writeToXml(PrintWriter pw1, int indent) {
        ...
        MekHqXmlUtil.writeSimpleXMLTag(pw1, indent, "loc", loc);
        MekHqXmlUtil.writeSimpleXMLTag(pw1, indent, "structureType", structureType);
        MekHqXmlUtil.writeSimpleXMLTag(pw1, indent, "clan", clan);
        MekHqXmlUtil.writeSimpleXMLTag(pw1, indent, "tsm", tsm);
        MekHqXmlUtil.writeSimpleXMLTag(pw1, indent, "percent", percent);
        MekHqXmlUtil.writeSimpleXMLTag(pw1, indent, "forQuad", forQuad);
