 ...
 * @author Neoancient
 */
public class OldUnitMarketDialog extends JDialog {
    ...
    //region Constructors
    public OldUnitMarketDialog(JFrame frame, Campaign c) {
        super(frame, true);
        campaign = c;
    ...
    private void purchaseUnit(ActionEvent evt) {
        if (null != selectedEntity) {
            ...
            unitMarket.getOffers().remove(selected);
