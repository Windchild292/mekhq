 ...
 * @author Neoancient
 */
public class OldContractMarketDialog extends JDialog {
    ...
    public OldContractMarketDialog(final JFrame frame, final Campaign campaign) {
        super(frame, true);
    ...
    private void initComponents() {
        ...
        btnGenerate.addActionListener(evt -> {
            Contract c = contractMarket.addContract(campaign);
    ...
    private void setUserPreferences() {
        PreferencesNode preferences = MekHQ.getPreferences().forClass(OldContractMarketDialog.class);
