...
public class CampaignOptionsDialog extends JDialog {
    ...
    public JPanel createPhenotypePanel() {
        ...
        phenotypesPanel.setBorder(BorderFactory.createTitledBorder(resources.getString("phenotypesPanel.border")));
    ...
    private JPanel createPersonnelRoleRecruitmentBonusPanel() {
        ...
        panRoleRecruitmentBonus.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder(resources.getString("panRoleRecruitmentBonus.border")),
                BorderFactory.createEmptyBorder(5, 5, 5, 5)));
    ...
    private JPanel createArtillerySkillPanel() {
        ...
        JLabel lblProbability = new JLabel(resources.getString("lblProbability.text"));
        ...
        JLabel lblBonus = new JLabel(resources.getString("lblBonus.text"));
    ...
    public void setOptions(CampaignOptions options) {
        // Use the provided options when possible, but flip if they are null to be safe
        if (options != null) {
    ...
    private void updateOptions() {
        ...
        for (int i = 0; i < Person.T_NUM; i++) {
            options.setPersonnelRoleRecruitmentBonus(i, (Integer) spnRoleRecruitmentBonus[i].getModel().getValue());
        }
        ...
        options.setSecondarySkillProbability((Integer) spnSecondaryProbability.getModel().getValue());
