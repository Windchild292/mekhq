...
public final class CommandCenterTab extends CampaignGuiTab {
    ...
    private void initInfoPanel() {
        ...
        lblExperience = new JLabel(getCampaign().getUnitRating().getAverageSkillLevel().toString());
    ...
    private void refreshBasicInfo() {
        ...
        lblExperience.setText(getCampaign().getUnitRating().getAverageSkillLevel().toString());
