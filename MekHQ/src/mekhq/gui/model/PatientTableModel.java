...
public class PatientTableModel extends AbstractListModel<Person> {
    ...
    private String getInjuriesDesc(Person p) {
        StringBuilder toReturn = new StringBuilder("<html><font size='2'><b>").append(p.getFullTitle(getCampaign()))
    ...
    private String getPatientDesc(Person p) {
        String toReturn = "<html><font size='2'><b>" + p.getFullTitle(getCampaign()) + "</b><br/>";
