...
public class CampaignGUI extends JPanel {
    ...
    private void setCampaignOptionsFromGameOptions() {
        ...
        getCampaign().getCampaignOptions().setInitBonus(getCampaign().getGameOptions().getOption(OptionsConstants.RPG_INDIVIDUAL_INITIATIVE).booleanValue());
        getCampaign().getCampaignOptions().setToughness(getCampaign().getGameOptions().getOption(OptionsConstants.RPG_TOUGHNESS).booleanValue());
        getCampaign().getCampaignOptions().setArtillery(getCampaign().getGameOptions().getOption(OptionsConstants.RPG_ARTILLERY_SKILL).booleanValue());
        getCampaign().getCampaignOptions().setAbilities(getCampaign().getGameOptions().getOption(OptionsConstants.RPG_PILOT_ADVANTAGES).booleanValue());
        getCampaign().getCampaignOptions().setEdge(getCampaign().getGameOptions().getOption(OptionsConstants.EDGE).booleanValue());
        getCampaign().getCampaignOptions().setImplants(getCampaign().getGameOptions().getOption(OptionsConstants.RPG_MANEI_DOMINI).booleanValue());
