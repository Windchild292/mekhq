            ...
            if (usesSoloPilot || isVTOL || isSmallCraftOrJumpShip) {
                ...
                if (!filteredPersonnel.isEmpty()) {
                    ...
                    for (final Person person : filteredPersonnel) {
                        ...
                        if (subMenu != null) {
                            final JMenuItem miPilot = new JMenuItem(person.getName().getFullTitle(person));
            ...
            if (isTank && !isVTOL) {
                ...
                if (!filteredPersonnel.isEmpty()) {
                    ...
                    for (final Person person : filteredPersonnel) {
                        ...
                        if (subMenu != null) {
                            final JMenuItem miDriver = new JMenuItem(person.getName().getFullTitle(person));
        ...
        if (canTakeMoreGunners && (isTank || isSmallCraftOrJumpShip)) {
            ...
            if (!filteredPersonnel.isEmpty()) {
                ...
                for (final Person person : filteredPersonnel) {
                    ...
                    if (subMenu != null) {
                        final JMenuItem miGunner = new JMenuItem(person.getName().getFullTitle(person));
        ...
        if (units[0].canTakeMoreVesselCrew() && (isAero || units[0].getEntity().isSupportVehicle())) {
            ...
            if (!filteredPersonnel.isEmpty()) {
                ...
                for (final Person person : filteredPersonnel) {
                    ...
                    if (subMenu != null) {
                        final JMenuItem miCrewmember = new JMenuItem(person.getName().getFullTitle(person));
            ...
            for (final Person person : personnel) {
                ...
                if (isTank) {
                    if (person.canDrive(units[0].getEntity()) || person.canGun(units[0].getEntity())) {
                        final JMenuItem miConsoleCommander = new JMenuItem(person.getName().getFullTitle(person));
                    ...
                    final JMenuItem miTechOfficer = new JMenuItem(person.getName().getFullTitle(person));
        ...
        if (units[0].usesSoldiers() && canTakeMoreGunners) {
            ...
            if (!filteredPersonnel.isEmpty()) {
                ...
                for (final Person person : filteredPersonnel) {
                    ...
                    if (subMenu != null) {
                        final JMenuItem miSoldier = new JMenuItem(person.getName().getFullTitle(person));
        ...
        if (units[0].canTakeNavigator()) {
            ...
            if (!filteredPersonnel.isEmpty()) {
                ...
                for (final Person person : filteredPersonnel) {
                    ...
                    if (subMenu != null) {
                        final JMenuItem miNavigator = new JMenuItem(person.getName().getFullTitle(person));
